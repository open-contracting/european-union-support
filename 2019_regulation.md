...
Start with the [fields](https://docs.ted.europa.eu/eforms/1.3.1/fields/index.html) identified by the eForms SDK (creates the file if it doesn't exist):
...
-- | -- | -- | --
id | [eForms SDK](https://docs.ted.europa.eu/eforms/1.3.1/fields/index.html#_field_properties) | Identifier of the field. |
...
[repeatable](https://docs.ted.europa.eu/eforms/1.3.1/fields/index.html#_dynamic_properties) | eForms SDK | Indicates if the field can appear more than once inside its container. | Simplified to the boolean (removed `severity`).
...
1. Look up the business term in the [eForms SDK](https://docs.ted.europa.eu/eforms/1.3.1/schema/all-in-one.html)
...
* [SDK](https://docs.ted.europa.eu/eforms/1.3.1/) ([all-in-one](https://docs.ted.europa.eu/eforms/1.3.1/schema/all-in-one.html))
