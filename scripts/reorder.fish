...
for i in F14
    move_line $i NEW_VALUE, SECTION
    move_line $i OLD_VALUE, SECTION

    move_line $i NEW_VALUE/NOTHING OLD_VALUE/NOTHING

    move_line $i NEW_VALUE/TEXT NEW_VALUE/NOTHING
    move_line $i OLD_VALUE/TEXT NEW_VALUE/NOTHING

    move_line $i NEW_VALUE/CPV_MAIN, OLD_VALUE/CPV_MAIN,
    move_line $i NEW_VALUE/CPV_MAIN/CPV_CODE OLD_VALUE/CPV_MAIN/CPV_CODE
    move_line $i NEW_VALUE/CPV_MAIN/CPV_SUPPLEMENTARY_CODE OLD_VALUE/CPV_MAIN/CPV_SUPPLEMENTARY_CODE

    move_line $i OLD_VALUE/DATE NEW_VALUE/CPV_ADDITIONAL/CPV_SUPPLEMENTARY_CODE
    move_line $i OLD_VALUE/TIME NEW_VALUE/DATE
end
