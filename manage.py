        ...
        ~df["ID"].isin(
            {
                ...
                # https://docs.ted.europa.eu/eforms/1.1.1/schema/all-in-one.html#extensionsSection
                "BT-53",  # Options (BT-54 Options Description)
                # https://docs.ted.europa.eu/eforms/1.1.1/schema/all-in-one.html#toolNameSection
                "BT-724",  # Tool Atypical (BT-124 Tool Atypical URL)
                # https://docs.ted.europa.eu/eforms/1.1.1/schema/all-in-one.html#_footnotedef_21
                "BT-778",  # Framework Maximum Participants (BT-113 Framework Maximum Participants Number)
                # See OPT-155 and OPT-156.
                # https://docs.ted.europa.eu/eforms/1.1.1/schema/competition-results.html#lotResultComponentsTable
                "BT-715",
                "BT-725",
                "BT-716",
                # See Table 3.
                # https://docs.ted.europa.eu/eforms/1.1.1/schema/parties.html#mappingOrganizationBTsSchemaComponentsTable
                "BT-08",
                "BT-770",
                # See Table 4 (also includes BT-330 and BT-1375).
                # https://docs.ted.europa.eu/eforms/1.1.1/schema/identifiers.html#pointlessDueToDesignSection
                "BT-557",
                "BT-1371",
                "BT-1372",
                "BT-1373",
...
def lint(filename):
    ...
    # See https://docs.ted.europa.eu/eforms/1.1.1/schema/schemas.html
    head = (
    ...
    for field in fields:
        ...
        if field["sdk"]:
            ...
            field["sdk"] = sdk_regex.sub("/1.1.1/", field["sdk"])
